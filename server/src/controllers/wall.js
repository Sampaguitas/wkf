...
const getAll = (req, res, next) => {
    ...
    matchDropdown(dropdown.sizeId, dropdown.lunar, dropdown.tag, dropdown.pffType).then(myMatch => {
...
function matchDropdown() {
    ...
    return new Promise(function(resolve) {
        resolve(["sizeId", "lunar", "tag", "pffType"].reduce(function(acc, cur, index) {
            if (myArgs[index] !== "") {
                if (["tag", "pffType"].includes(cur)) {
                    acc[`${cur}s`] = myArgs[index];
                } else if (cur === "sizeId") {
                    acc[`${cur}X`] = String(myArgs[index]);
                } else {
