...
export default class Searchtypes extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            params: {
                ...
                minSize: { value: "", placeholder: "Min Size", selection: { _id: "", name: ""}, options: [], hover: "", page: 0 },
                maxSize: { value: "", placeholder: "Max Size", selection: { _id: "", name: ""}, options: [], hover: "", page: 0 },
                ...
                types: { value: "", placeholder: "Types", selection: { _id: "", name: ""}, options: [], hover: "", page: 0 },
                ...
                searchtype_name: { value: "", placeholder: "Name", selection: { _id: "", name: ""}, options: [], hover: "", page: 0 },
                searchtype_pffType: { value: "", placeholder: "PFF Type", selection: { _id: "", name: ""}, options: [], hover: "", page: 0 },
                searchtype_minSize: { value: "", placeholder: "Min Size", selection: { _id: "", name: ""}, options: [], hover: "", page: 0 },
                searchtype_maxSize: { value: "", placeholder: "Max Size", selection: { _id: "", name: ""}, options: [], hover: "", page: 0 },
                searchtype_lunar: { value: "", placeholder: "vLunar", selection: { _id: "", name: ""}, options: [], hover: "", page: 0 },
                searchtype_tags: { value: "", placeholder: "Tags", selection: { _id: "", name: ""}, options: [], hover: "", page: 0, selectionArray: [] },
                searchtype_types: { value: "", placeholder: "Types", selection: { _id: "", name: ""}, options: [], hover: "", page: 0, selectionArray: [] },
            },
            focused: "",
            alert: {
                type: "",
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        if (this.state.params.minSize.selection._id !== prevState.params.minSize.selection._id) this.getDocuments();
        if (this.state.params.maxSize.selection._id !== prevState.params.maxSize.selection._id) this.getDocuments();
        ...
        if (this.state.params.types.selection._id !== prevState.params.types.selection._id) this.getDocuments();
        ...
        if (this.state.params.minSize.value !== prevState.params.minSize.value) this.getDropdownOptions("minSize", 0);
        if (this.state.params.maxSize.value !== prevState.params.maxSize.value) this.getDropdownOptions("maxSize", 0);
        ...
        if (this.state.params.types.value !== prevState.params.types.value) this.getDropdownOptions("types", 0);
        ...
        if (this.state.params.searchtype_name.value !== prevState.params.searchtype_name.value) this.getDropdownOptions("searchtype_name", 0);
        if (this.state.params.searchtype_pffType.value !== prevState.params.searchtype_pffType.value) this.getDropdownOptions("searchtype_pffType", 0);
        if (this.state.params.searchtype_minSize.value !== prevState.params.searchtype_minSize.value) this.getDropdownOptions("searchtype_minSize", 0);
        if (this.state.params.searchtype_maxSize.value !== prevState.params.searchtype_maxSize.value) this.getDropdownOptions("searchtype_maxSize", 0);
        if (this.state.params.searchtype_lunar.value !== prevState.params.searchtype_lunar.value) this.getDropdownOptions("searchtype_lunar", 0);
        if (this.state.params.searchtype_tags.value !== prevState.params.searchtype_tags.value) this.getDropdownOptions("searchtype_tags", 0);
        if (this.state.params.searchtype_types.value !== prevState.params.searchtype_types.value) this.getDropdownOptions("searchtype_types", 0);
    ...
    getDocuments(nextPage) {
        ...
        if (!!paginate.pageSize) {
            this.setState({
                ...
                const requestOptions = {
                    ...
                    body: JSON.stringify({
                        ...
                        dropdown: {
                            ...
                            minSize: params.minSize.selection._id,
                            maxSize: params.maxSize.selection._id,
                            lunar: params.lunar.selection._id,
                            tags: params.tags.selection._id,
                            types: params.types.selection._id,
                ...
                return fetch(`${process.env.REACT_APP_API_URI}/server/searchtypes/getAll`, requestOptions)
        ...
        if (!upserting) {
            this.setState({
                ...
                const requestOptions = {
                    ...
                    headers: { ...authHeader(), "Content-Type": "application/json" },
                    body: JSON.stringify({
                        name: params.searchtype_name.selection._id,
                        pffType: params.searchtype_pffType.selection._id,
                        minSize: params.searchtype_minSize.selection._id,
                        maxSize: params.searchtype_maxSize.selection._id,
                        lunar: params.searchtype_lunar.selection._id,
                        tags: params.searchtype_tags.selectionArray,
                        types: params.searchtype_types.selectionArray,
                    })
                };
                return fetch(`${process.env.REACT_APP_API_URI}/server/searchtypes/${!!this.state._id ? this.state._id : ""}`, requestOptions)
                .then(response => response.text().then(text => {
                    this.setState({
                        upserting: false,
                    }, () => {
    ...
    handleDelete(event) {
        ...
        if (!!_id && !deleting && !!window.confirm("Would you like to permanantly delete the entry?")) {
            this.setState({
                ...
                return fetch(`${process.env.REACT_APP_API_URI}/server/searchtypes/${_id}`, requestOptions)
                .then(response => response.text().then(text => {
                    this.setState({
                        deleting: false,
                    }, () => {
            ...
            elements.map((element) => {
                tempRows.push(
                    <tr key={element._id}>
                        ...
                        <TableData colIndex="3" value={element.minSize} type="text" settingsColWidth={settingsColWidth} handleClick={this.handleOnclick} eventId={element._id} />
                        <TableData colIndex="4" value={element.maxSize} type="text" settingsColWidth={settingsColWidth} handleClick={this.handleOnclick} eventId={element._id} />
    ...
    getDropdownOptions(key, page) {
        ...
        this.setState({
            ...
            return fetch(`${process.env.REACT_APP_API_URI}/server/searchtypes/getDrop/${key}`, requestOptions)
            .then(response => response.text().then(text => {
                this.setState({
                    loading: false,
                }, () => {
                                        ...
                                        <section id="singles" className="drop-section">
                                            ...
                                            <div className="row row-cols-1 row-cols-md-2">
                                                ...
                                                <ParamSelect
                                                    key="0"
                                                    name="searchtype_name"
                                                    isFocused={params.searchtype_name.isFocused}
                                                    focused={focused}
                                                    value={params.searchtype_name.value}
                                                    placeholder={params.searchtype_name.placeholder}
                                                    selection={params.searchtype_name.selection}
                                                    options={params.searchtype_name.options}
                                                    hover={this.state.params.searchtype_name.hover}
                                                    page={params.searchtype_name.page}
                                                    onChange={this.handleChange}
                                                    handleNext={this.handleNext}
                                                    handleSelect={this.handleSelect}
                                                    onFocus={this.onFocus}
                                                ...
                                                <ParamSelect
                                                    key="1"
                                                    name="searchtype_pffType"
                                                    isFocused={params.searchtype_pffType.isFocused}
                                                    focused={focused}
                                                    value={params.searchtype_pffType.value}
                                                    placeholder={params.searchtype_pffType.placeholder}
                                                    selection={params.searchtype_pffType.selection}
                                                    options={params.searchtype_pffType.options}
                                                    hover={this.state.params.searchtype_pffType.hover}
                                                    page={params.searchtype_pffType.page}
                                                    onChange={this.handleChange}
                                                    handleNext={this.handleNext}
                                                    handleSelect={this.handleSelect}
                                                    onFocus={this.onFocus}
                                                ...
                                                <ParamSelect
                                                    key="2"
                                                    name="searchtype_minSize"
                                                    isFocused={params.searchtype_minSize.isFocused}
                                                    focused={focused}
                                                    value={params.searchtype_minSize.value}
                                                    placeholder={params.searchtype_minSize.placeholder}
                                                    selection={params.searchtype_minSize.selection}
                                                    options={params.searchtype_minSize.options}
                                                    hover={this.state.params.searchtype_minSize.hover}
                                                    page={params.searchtype_minSize.page}
                                                    onChange={this.handleChange}
                                                    handleNext={this.handleNext}
                                                    handleSelect={this.handleSelect}
                                                    onFocus={this.onFocus}
                                                ...
                                                <ParamSelect
                                                    key="3"
                                                    name="searchtype_maxSize"
                                                    isFocused={params.searchtype_maxSize.isFocused}
                                                    focused={focused}
                                                    value={params.searchtype_maxSize.value}
                                                    placeholder={params.searchtype_maxSize.placeholder}
                                                    selection={params.searchtype_maxSize.selection}
                                                    options={params.searchtype_maxSize.options}
                                                    hover={this.state.params.searchtype_maxSize.hover}
                                                    page={params.searchtype_maxSize.page}
                                                    onChange={this.handleChange}
                                                    handleNext={this.handleNext}
                                                    handleSelect={this.handleSelect}
                                                    onFocus={this.onFocus}
                                                ...
                                                <ParamSelect
                                                    key="4"
                                                    name="searchtype_lunar"
                                                    isFocused={params.searchtype_lunar.isFocused}
                                                    focused={focused}
                                                    value={params.searchtype_lunar.value}
                                                    placeholder={params.searchtype_lunar.placeholder}
                                                    selection={params.searchtype_lunar.selection}
                                                    options={params.searchtype_lunar.options}
                                                    hover={this.state.params.searchtype_lunar.hover}
                                                    page={params.searchtype_lunar.page}
                                                    onChange={this.handleChange}
                                                    handleNext={this.handleNext}
                                                    handleSelect={this.handleSelect}
                                                    onFocus={this.onFocus}
