...
export default class Lengths extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            _id: "",
            ...
            params: {
                ...
                length_name: { value: "", placeholder: "Name", selection: { _id: "", name: ""}, options: [], hover: "", page: 0 },
                length_lunar: { value: "", placeholder: "vLunar", selection: { _id: "", name: ""}, options: [], hover: "", page: 0 },
                length_tags: { value: "", placeholder: "Tags", selection: { _id: "", name: ""}, options: [], hover: "", page: 0, selectionArray: [] },
                length_pffTypes: { value: "", placeholder: "PFF Types", selection: { _id: "", name: ""}, options: [], hover: "", page: 0, selectionArray: [] },
            },
            focused: "",
            alert: {
                type: "",
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        if (this.state.params.length_tags.value !== prevState.params.length_tags.value) this.getDropdownOptions("length_tags", 0);
        if (this.state.params.length_pffTypes.value !== prevState.params.length_pffTypes.value) this.getDropdownOptions("length_pffTypes", 0);
    ...
    getDocuments(nextPage) {
        ...
        if (!!paginate.pageSize) {
            this.setState({
                ...
                return fetch(`${process.env.REACT_APP_API_URI}/server/lengths/getAll`, requestOptions)
        ...
        if (!upserting) {
            this.setState({
                ...
                const requestOptions = {
                    ...
                    headers: { ...authHeader(), "Content-Type": "application/json" },
                    body: JSON.stringify({
                        name: params.length_name.selection._id,
                        lunar: params.length_lunar.selection._id,
                        tags: params.length_tags.selectionArray,
                        pffTypes: params.length_pffTypes.selectionArray,
                    })
                };
                return fetch(`${process.env.REACT_APP_API_URI}/server/lengths/${!!this.state._id ? this.state._id : ""}`, requestOptions)
                .then(response => response.text().then(text => {
                    this.setState({
                        upserting: false,
                    }, () => {
    ...
    handleDelete(event) {
        ...
        if (!!_id && !deleting && !!window.confirm("Would you like to permanantly delete the entry?")) {
            this.setState({
                ...
                return fetch(`${process.env.REACT_APP_API_URI}/server/lengths/${_id}`, requestOptions)
                .then(response => response.text().then(text => {
                    this.setState({
                        deleting: false,
                    }, () => {
        ...
        if (!!currentUser.isAdmin) {
            this.setState({
                ...
                params: {
                    ...
                    length_name: { value: "", placeholder: "Name", selection: { _id: "", name: ""}, options: [], hover: "", page: 0 },
                    length_lunar: { value: "", placeholder: "vLunar", selection: { _id: "", name: ""}, options: [], hover: "", page: 0 },
                    length_tags: { value: "", placeholder: "Tags", selection: { _id: "", tags: ""}, options: [], hover: "", page: 0, selectionArray: [] },
                    length_pffTypes: { value: "", placeholder: "PFF Types", selection: { _id: "", name: ""}, options: [], hover: "", page: 0, selectionArray: [] },
                },
                ...
                .then(response => response.text().then(text => {
                    ...
                    if (response.status === 401) {
                        ...
                        this.setState({
                            params: {
                                ...this.state.params,
                                length_name: { value: data.doc.name || "", placeholder: "Name", selection: { _id: data.doc.name || "", name: data.doc.name || ""}, options: [], hover: "", page: 0 },
                                length_lunar: { value: data.doc.lunar, placeholder: "vLunar", selection: { _id: data.doc.lunar, name: data.doc.lunar}, options: [], hover: "", page: 0 },
                                length_tags: { value: "", placeholder: "Tags", selection: { _id: "", tags: ""}, options: [], hover: "", page: 0, selectionArray: [...data.doc.tags] },
                                length_pffTypes: { value: "", placeholder: "PFF Types", selection: { _id: "", name: ""}, options: [], hover: "", page: 0, selectionArray: [...data.doc.pffTypes] },
                            },
                            retrievingElement: false,
                        });
                    }
    ...
    getDropdownOptions(key, page) {
        ...
        this.setState({
            ...
            return fetch(`${process.env.REACT_APP_API_URI}/server/lengths/getDrop/${key}`, requestOptions)
            .then(response => response.text().then(text => {
                this.setState({
                    loading: false,
                }, () => {
                                ...
                                (
                                    <div className="modal-body-content">
                                        <section id="singles" className="drop-section">
                                            ...
                                            <div className="row row-cols-1 row-cols-md-2">
                                                <ParamInput
                                                    ...
                                                    name="length_name"
                                                    focused={focused}
                                                    value={params.length_name.selection.name}
                                                    placeholder={params.length_name.placeholder}
                                                ...
                                                <ParamInput
                                                    ...
                                                    name="length_lunar"
                                                    focused={focused}
                                                    value={params.length_lunar.selection.name}
                                                    placeholder={params.length_lunar.placeholder}
                                                    onChange={this.handleChangeInput}
                                                    onFocus={this.onFocus}
                                                    handleClearValue={this.handleClearValue}
                                                />
                                        ...
                                        <section id="pfftypes" className="drop-section">
                                            ...
                                            <ParamTagSelect
                                                key="3"
                                                name="length_pffTypes"
                                                object={params.length_pffTypes}
                                                focused={focused}
                                                onChange={this.handleChange}
                                                handleNext={this.handleNext}
                                                handleSelect={this.handleSelect}
