...
class ParamTagInput extends Component{
    ...
    render() {
        const { name, object, focused, onChange, onFocus, addTag, handleClearValue } = this.props;
        const { value, placeholder, selection, selectionArray } = object;
        return(
